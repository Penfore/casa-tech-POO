...
public class ClienteVO {
	...
	public void setEnderecoRua(String enderecoRua) { 
		if(endereco!=null && !enderecoRua.equals("")) { // Deveríamos permitir que fosse opcional o cadastro desse dado?
	...
	public void setCpf(String cpf) { 
		if(cpf!=null && !cpf.equals("")) { // Deveríamos permitir que fosse opcional o cadastro desse dado?
			if (cpf.length() == 11)
			{
				...
				{
					if ((!cpf.equals("00000000000")) && (!cpf.equals("11111111111")) // Expressão
